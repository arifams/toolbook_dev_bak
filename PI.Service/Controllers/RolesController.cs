...
namespace PI.Service.Controllers
{
    ...
    public class RolesController : BaseApiController
    {
        ...
        [Route("create")]
        public async Task<IHttpActionResult> Create(RoleBindingModels.CreateRoleBindingModel model)
        {
        ...
        public async Task<IHttpActionResult> ManageUsersInRole(RoleBindingModels.UsersInRoleModel model)
        {
