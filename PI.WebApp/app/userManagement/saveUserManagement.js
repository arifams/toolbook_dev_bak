        ...
        return {
            ...
            link: function (scope, elm, attrs, ctrl) {
                ctrl.$parsers.unshift(function (viewValue, $scope) {
                    var noMatch = viewValue != scope.cont.formSaveUser.password.$viewValue;
        ...
        return {
            ...
            link: function (scope, elm, attrs, ctrl) {
                ctrl.$parsers.unshift(function (viewValue, $scope) {
                    ...
                    if (scope.cont.formSaveUser.password_c.$viewValue != '') {
                        var noMatch = viewValue != scope.cont.formSaveUser.password_c.$viewValue;
                        scope.cont.formSaveUser.password_c.$setValidity('noMatch', !noMatch);
                    }
