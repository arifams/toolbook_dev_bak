...
registerExternalUser, ngAuthSettings) {
        ...
        vm.resetForgetPasswordUsingEmail = function () {
            debugger;
            vm.pwdReset.templateLink = '<html><head><title></title></head><body style="margin:30px;"><div style="margin-right:40px;margin-left:40px"><div style="margin-top:30px;background-color:#0af;font-size:28px;border:5px solid #d9d9d9;text-align:center;padding:10px;font-family:verdana,geneva,sans-serif;color:#fff">Password Reset - One2send</div></div><div style="margin-right:40px;margin-left:40px"><div style="float:left;"><img alt="" src="http://www.12send.com/template/logo_12send.png" style="width: 193px; height: 100px;" /></div><div><h3 style="margin-bottom:65px;margin-right:146px;margin-top:0;padding-top:62px;text-align:center;font-size:22px;font-family:verdana,geneva,sans-serif;color:#005c99">Password reset instructions</h3></div></div><div style="margin-right:40px;margin-left:40px"><div style="padding:10px;font-family:verdana,geneva,sans-serif;color:#fff;border:5px solid #0af;background-color:#005c99;font-size:13px"><p style="font-weight:700;font-style:italic;font-size:14px">Dear FirstName LastName,</p><br/><p style="font-weight:700;font-style:italic;font-size:14px">We received a request to reset the password associated with this email address. If you made this request, please go to the following page and choose a new password: <span style="color:#80d4ff;font-size:14px;">ActivationURL</span></p><p style="font-weight:700;font-style:italic;font-size:14px">If you did not make this request, please disregard this email.</p><p style="font-weight:700;font-style:italic;font-size:14px">Thank you for using One2send, we look forward to providing a shipment for you soon. If you need assistance, you can reach out to our One2send Service Team.</p><br/><p style="color:#fff">Phone: <span style="font-size:14px;color:#80d4ff">+1 858 914 4414</span> </p><p style="color:#fff">Email address:<a href="support@12send.com" style="color:#80d4ff">support@12send.com</a></p><p style="color:#fff">Website: <a href="http://www.12send.com" style="color:#80d4ff">www.12send.com </a></p></div><p><i>*** This is an automatically generated email, please do not reply ***</i></p></div></body></html>';
