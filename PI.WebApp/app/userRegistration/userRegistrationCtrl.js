...
function (registerUserService, $window, $rootScope, authService, $scope, ngAuthSettings) {
    ...
    vm.user.templateLink = '<html><head><title></title></head><body style="margin:30px;"><div style="margin-right:40px;margin-left:40px"><div style="margin-top:30px;background-color:#0af;font-size:28px;border:5px solid #d9d9d9;text-align:center;padding:10px;font-family:verdana,geneva,sans-serif;color:#fff">Account Activation - One2send</div></div><div style="margin-right:40px;margin-left:40px"><div style="float:left;"><img alt="" src="http://www.12send.com/template/logo_12send.png" style="width:193px;height:100px;" /></div><div><h3 style="margin-bottom:65px;margin-right:146px;margin-top:0;padding-top:62px;text-align:center;font-size:20px;font-family:verdana,geneva,sans-serif;color:#005c99">Thank you for registering with One2send</h3></div></div><div style="margin-right:40px;margin-left:40px"><div style="padding:10px;font-family:verdana,geneva,sans-serif;color:#fff;border:5px solid #0af;background-color:#005c99;font-size:13px"><p style="font-weight:700;font-style:italic;font-size:14px">Dear FirstName LastName,</p><br/><p style="font-weight:700;font-style:italic;font-size:14px">Welcome to One2Send! We are looking forward to supporting all your shipping needs. </p><p style="font-weight:700;font-style:italic;font-size:14px">Before we can start shipping for you, we need to verify your registration.</p><p style="font-weight:700;font-style:italic;font-size:14px">Please click <span style="color:#80d4ff;font-size:14px;">ActivationURL</span> to verify your email address.</p><p style="font-weight:700;font-style:italic;font-size:14px">The link will be valid for 24 hours.<p><p style="font-weight:700;font-style:italic;font-size:14px">In need of assistance? Reach out to our support team.</p><p style="font-weight:700;font-style:italic;font-size:14px">You can contact us via</p><br/><p>Phone: <span style="font-size:14px;color:#80d4ff">+31 (0) 10 418 1000</span> </p><p>Email address: <a href="support@12send.com " style="color:#80d4ff">support@12send.com </a></p></div><p><i>*** This is an automatically generated email, please do not reply ***</i></p></div></body></html>';
    vm.UserModel = {};
