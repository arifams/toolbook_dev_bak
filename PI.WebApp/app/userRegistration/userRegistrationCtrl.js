...
(function (app) {
    ...
    app.controller('userRegistrationCtrl',
        ['registerUserService', '$window', '$rootScope', 'authService', function (registerUserService, $window, $rootScope, authService) {
...
})(angular.module('userRegistration', ['ngMessages', 'ngCookies', 'gettext', 'LocalStorageModule']));
