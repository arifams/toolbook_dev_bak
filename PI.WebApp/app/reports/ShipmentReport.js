...
(function (app) {
    ...
    app.controller('loadAddressesCtrl', ['$route', '$scope', '$location', 'loadAddressService', 'addressManagmentService',
        '$routeParams', '$log', '$window', '$sce', 'importAddressBookFactory', 'exportAddressExcelFactory', 'Upload',
        '$timeout',
        function ($route, $scope, $location, loadAddressService, addressManagmentService, $routeParams,
            $log, $window, $sce, importAddressBookFactory, exportAddressExcelFactory, Upload, $timeout) {
        var vm = this;
        vm.stream = {};
