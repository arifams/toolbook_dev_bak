...
.directive('countrySelect', function () {
    ...
    return {
        ...
        template: '<select ng-options="country.code as country.name for country in countries"> <option value="">Select Country</option> </select>',
        controller: [
...
.directive('validPhoneNo', function () {
    return {
        require: 'ngModel',
